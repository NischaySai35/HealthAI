...
export default function UploadPage({ onNavigate }) {
  ...
  const handleCSVUpload = (e) => {
    // Feature not implemented yet - file selected but nothing happens
    e.preventDefault();
  };
    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {/* CSV Upload */}
          <div className="relative bg-slate-800/50 border border-slate-700/50 rounded-xl p-8 hover:border-blue-500/50 transition">
            <div className="absolute top-3 right-3 flex items-center gap-1 bg-yellow-500/10 border border-yellow-500/30 rounded-full px-3 py-1">
              <span className="text-yellow-400 text-xs font-semibold">⏳ Feature in development</span>
            </div>
